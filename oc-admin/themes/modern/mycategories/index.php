...
<?php
  ...
  var me = 1;
    $(".sortable li").each(function(i){        
        if(i%5==0){
            $(this).before("<span class='no-nest'>Row " + (me++) + "</span>");
        }
    });
...
?>
<li id="list_<?php echo $category['pk_i_id']; ?>" class="category_li no-nest <?php echo ( $category['b_enabled'] == 1 ? 'enabled' : 'disabled' ); ?> " >
                ...
                <div class="categories">
                    ...
                    <div class="list-categories">
                        ...
                        <?php foreach($categories as $category) {
                            if( count($category['categories']) > 0 ) { $has_subcategories = false; } else { $has_subcategories = false; }
